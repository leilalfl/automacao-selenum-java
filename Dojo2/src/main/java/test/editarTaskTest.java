...
@DataLoader(filePaths = "C:\\Users\\Inmetrics\\eclipse-workspace\\Dojo2\\src\\main\\java\\massa\\DadosParaEdicao.csv")
...
public class editarTaskTest {
	...
	public static void createTasksTest() {
		...
		task.preencherCamposCreateTask("TESTE EDIT");
		assertEquals("TESTE EDIT", task.capturarTituloTask());
	}
	...
	public void editarTaskTest(@Param(name="subject")String Subject, @Param(name="newSubject")String newSubject) {
		...
		String screenshotArquivoAntes = "C:\\Users\\Inmetrics\\eclipse-workspace\\Dojo2\\src\\main\\java\\test" +Generator.dataHoraParaArquivo() 
		...
		String screenshotArquivoDepois = "C:\\Users\\Inmetrics\\eclipse-workspace\\Dojo2\\src\\main\\java\\test" +Generator.dataHoraParaArquivo() 
		+ test.getMethodName() + ".png";
	...
	@Test
	public void editarCamposTodosTest(@Param(name="subject")String Subject, @Param(name="newSubject")String newSubject, 
			@Param(name="status")String NewStatus, @Param(name="newRelatedTo")String newRelatedTo, 
