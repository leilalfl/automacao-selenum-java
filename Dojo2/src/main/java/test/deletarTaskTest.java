...
@DataLoader(filePaths = "C:\\Users\\Inmetrics\\eclipse-workspace\\Dojo2\\src\\main\\java\\massa\\DadosParaDelete.csv")
...
public class deletarTaskTest {
	...
	public static void createTasksTest() {
		...
		task.preencherCamposCreateTask("TESTE DELETE 5");
		assertEquals("TESTE DELETE 5", task.capturarTituloTask());
	}
	...
	public void deleteTaskTest(@Param(name="subject")String Subject) {
		...
		String screenshotArquivo = "C:\\Users\\Inmetrics\\eclipse-workspace\\Dojo2\\src\\main\\java\\test" +Generator.dataHoraParaArquivo() 
