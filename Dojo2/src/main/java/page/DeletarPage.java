...
//		String screenshotArquivoMsg = "C:\\Users\\Inmetrics\\eclipse-workspace\\Dojo2\\src\\main\\java\\test" +Generator.dataHoraParaArquivo() 
//		+ test.getMethodName() + ".png";
//		Screenshot.tirar(driver, screenshotArquivoMsg);
